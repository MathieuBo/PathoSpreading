...
conn_names = [i.split(' (')[0] for i in
              connectivity_contra.columns]  # Extract the name of the brain regions but not the subregions
...
path_data_objects = [path_data, conn_names, orig_order,
                     n_regions]  # Will depend on whether we will import directly this whole code ==> Need to check
